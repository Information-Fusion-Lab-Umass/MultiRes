...
def normalize_data_list(data_list: list, normalize_strat='mean'):
    ...
    global_covariates_mean, global_covariates_std, global_covariates_min, global_covariates_max = evaluate_df_statistic(global_covariates)
