...
def get_mean_imputation(data_path):
    imputation = {}
    data = pickle.load(open(data_path, 'rb'))
    train_ids = data['train_ids']
    test_ids = data['test_ids']
...
if __name__ == '__main__':
    ...
    a = pickle.load(open('./data/forward_physionet_2.pkl', 'rb'))
    # print(a['train']['data'])
    # pass
    if method == 'tbm':
        print('data1')
    ...
    if method == 'mean':
        print('data1')
        data = get_mean_imputation('./data/phy_data_set_1.pkl')
        pickle.dump(data, open('./data/mean_physionet_1.pkl', 'wb'))
        print

        print('data2')
        data = get_mean_imputation('./data/phy_data_set_2.pkl')
        pickle.dump(data, open('./data/mean_physionet_2.pkl', 'wb'))
        print

        print('data3')
        data = get_mean_imputation('./data/phy_data_set_3.pkl')
        pickle.dump(data, open('./data/mean_physionet_3.pkl', 'wb'))
