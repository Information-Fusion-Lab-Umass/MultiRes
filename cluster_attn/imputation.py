...
if __name__ == '__main__':
    data = get_imputation('/home/sidongzhang/code/fl/data/final_Physionet_avg_new.pkl', 50)
    # print(data['train']['data'][0])
    pickle.dump(data, open('/home/sidongzhang/code/fl/data/pc_physionet.pkl', 'wb'))